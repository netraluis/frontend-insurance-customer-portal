    ...
    <html>
      <head>
        <style>
          ...
          .injuries-description { background-color: #f9f9f9; padding: 10px; border-radius: 4px; margin-top: 10px; }
        </style>
      </head>
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <table>
              ...
              <tr>
                <td>Driver Name:</td>
                <td>${formData.driverFirstName} ${formData.driverLastName}</td>
              </tr>
              <tr>
                <td>Date of Birth:</td>
                <td>${formData.driverDateOfBirth ? format(new Date(formData.driverDateOfBirth), "PPP") : "Not provided"}</td>
              </tr>
              ${
                formData.driverID
                  ? `
            ...
            `
              ...
              <tr>
                <td colspan="2">
                  <strong>Injuries Description:</strong>
                  <div class="injuries-description">${formData.bodilyInjuriesDescription}</div>
                </td>
              </tr>
              `
                  : ""
              ...
              <tr>
                <th colspan="2">Damage Information</th>
              </tr>
              <tr>
                <td colspan="2">
                  <strong>Damage Description:</strong>
                  <div class="injuries-description">${formData.damageDescription}</div>
                </td>
              </tr>
              <tr>
                <td>Photos Attached:</td>
                <td>${formData.damagePhotos.length > 0 ? `${formData.damagePhotos.length} photo${formData.damagePhotos.length > 1 ? "s" : ""}` : "None"}</td>
              </tr>
            </table>
