...
import { GeneralFormStepper } from "./general-form-stepper"
import PolicyInformation from "./general-steps/policy-information"
import AccidentDetails from "./general-steps/accident-details"
import AdditionalInformation from "./general-steps/additional-information"
import InvolvedParties from "./general-steps/involved-parties"
import AdditionalDocumentation from "./general-steps/additional-documentation"
import ReviewSubmit from "./general-steps/review-submit"
...
export default function GeneralClaimFormLayout() {
  const { currentStep, setCurrentStep, isStepComplete, loadProgress, isSubmitted, isSubmitting } = useGeneralClaimForm()
